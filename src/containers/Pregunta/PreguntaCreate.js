...
class Pregunta extends React.Component {
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
            ...
            <select
              ...
              value={this.state.temarelevante}
              onChange={this.handleTemaRelevante}
            >
  ...
  handleSubmit = e => {
    ...
    let preguntaPost = {
      ...
      GruposInteres: [this.state.grupointeres],
      Name: this.state.descripcion
    };

    let url =
      "http://190.85.67.146/TEST/MATERIALIDAD/api/Pregunta/CreateDeepGin";

    //traer preguntas
    axios
      .post(url, preguntaPost)
      .then(response => {
